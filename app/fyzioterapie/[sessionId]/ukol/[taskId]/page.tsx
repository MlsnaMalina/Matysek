...
export default function UkolDetailFyzio({ params }: { params: Promise<{ sessionId: string; taskId: string }> }) {
        ...
        {editingDesc ? (
          <div>
            <textarea
              ...
              rows={6}
              placeholder="Napiš instrukce k tomuto cviku..."
          ...
          >
            Klepnutím přidej instrukce k tomuto cviku
          </button>
        )}
      </div>
    </main>

...
export default function NovaSchuzeLogopedie() {
  ...
  return (
    <main className="min-h-screen max-w-sm mx-auto pb-10">
      <BackHeader title="Nová schůzka" href="/logopedie" />
      ...
      <div className="px-4 space-y-5">
        ...
        <div>
            ...
            {tasks.map((task, i) => (
              <div key={i} className="flex gap-2">
                <input
                  ...
                  placeholder={`Úkol ${i + 1} (např. hláska Š)`}
          ...
          <button
            onClick={addTask}
            className="mt-2 flex items-center gap-1.5 text-sm py-2"
        ...
        >
          <p className="font-medium mb-1" style={{ color: cfg.dark }}>Nahrávka</p>
